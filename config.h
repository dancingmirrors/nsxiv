...
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       "yellow" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "black" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "Terminus:style=Bold:size=12" };
